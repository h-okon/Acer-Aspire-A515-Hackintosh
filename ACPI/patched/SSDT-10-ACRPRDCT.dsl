 ...
 *
 * Disassembly of SSDT-10-ACRPRDCT.aml, Sat Dec 21 22:20:55 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003C46 (15430)
 *     Revision         0x01
 *     Checksum         0x1C
 *     OEM ID           "ACRSYS"
...
DefinitionBlock ("", "SSDT", 1, "ACRSYS", "ACRPRDCT", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (SGOP, SystemMemory, 0x8A88D018, 0x46)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0x8AF13018, 0x2018)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        ...
        Method (GETD, 2, Serialized)
        {
            ...
            While (One)
            {
                Store (ToInteger (\_SB.PCI0.RP01.PXSX.MADL), _T_0)
                If (LEqual (_T_0, 0x07))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.RP01.PXSX.MSTE), _T_1)
                        If (LEqual (_T_1, One))
                        {
                ...
                ElseIf (LEqual (_T_0, 0x06))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.RP01.PXSX.MSTE), _T_2)
                        If (LEqual (_T_2, 0x02))
                        {
                            Store (0x02, \_SB.PCI0.RP01.PXSX.CTOI)
                            Store (0x03, \_SB.PCI0.RP01.PXSX.NTOI)
                ...
                ElseIf (LEqual (_T_0, 0x05))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.RP01.PXSX.MSTE), _T_3)
                        If (LEqual (_T_3, One))
                        {
                            Store (One, \_SB.PCI0.RP01.PXSX.CTOI)
                            Store (0x03, \_SB.PCI0.RP01.PXSX.NTOI)
                ...
                ElseIf (LEqual (_T_0, 0x03))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.RP01.PXSX.MSTE), _T_4)
                        If (LEqual (_T_4, One))
                        {
                            Store (One, \_SB.PCI0.RP01.PXSX.CTOI)
                            Store (0x02, \_SB.PCI0.RP01.PXSX.NTOI)
                ...
                Else
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.RP01.PXSX.MSTE), _T_5)
                        If (LEqual (_T_5, One))
                        {
                            Store (One, \_SB.PCI0.RP01.PXSX.CTOI)
                            Store (One, \_SB.PCI0.RP01.PXSX.NTOI)
        ...
        Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
        {
            ...
            If (LEqual (Arg0, ToUUID ("95db88fd-940a-4253-a446-70ce0504aedf")))
            {
                ...
                {
                    Return (\_SB.PCI0.IGPU.SPB (Arg0, Arg1, Arg2, Arg3))
                }
            }
